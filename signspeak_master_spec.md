...
| Tối giản / cắt nếu thiếu thời gian | `register.html` (form đơn giản)                                                              |
...
_(Đây là phạm vi có chủ đích, không phải lỗi — cần nêu rõ để hội đồng đánh giá đúng kỳ vọng.)_
...
| ------------------------- | ---------------------- | -------------------------------------------------------- |
| Accuracy nhận diện cử chỉ | ≥80%                   | Trên tập test tự quay, độc lập với tập train             |
